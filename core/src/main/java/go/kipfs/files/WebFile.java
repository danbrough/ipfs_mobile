 ...
 */
public final class WebFile implements Seq.Proxy, File, FileInfo, Node, go.kipfs.core.Closer, go.kipfs.core.KReader, go.kipfs.core.ReadCloser, go.kipfs.core.Reader {
	static { Files.touch(); }
