...
// Java class go.kipfs.core.Node is a proxy for talking to a Go program.
//
...
public final class Node implements Seq.Proxy {
	...
	public Node(Repo r, boolean online) {
		this.refnum = __NewNode(r, online);
		Seq.trackGoRef(refnum, this);
	}
	
	private static native int __NewNode(Repo r, boolean online);
